...
from parameters_tuning import HPO_EXPERIMENT_NAME
...
def train_best_model(train_data_path, config, model_path):
    ...
    print(f"Run name: {run.data.tags['mlflow.runName']}, {run.info.run_id}, {run.data.params}")
    ...
    print(f'model logged and registered to {model_uri}')
