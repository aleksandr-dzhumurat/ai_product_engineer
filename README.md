...
| NLP | [→](#nlp) |
| ML: от моделей к проектам | [→](#ml-от-моделей-к-проектам) |
...
| Лекция 08 vol 01: Введение в рекомендательные системы: content-based | [→](#лекция-08-vol-01-введение-в-рекомендательные-системы-content-based) |
