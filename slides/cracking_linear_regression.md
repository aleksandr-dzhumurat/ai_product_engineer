...
### Идеальный вариант
Прогнозировать **прирост прибыли** (Δ Profit), т.к. именно его мы хотим максимизировать.
...
### Практичное решение
Прогнозировать **прирост продаж** (Δ Sales), затем через статическую формулу получить прирост прибыли:
...
Логарифмирование вносит **нелинейность** по фичам:
