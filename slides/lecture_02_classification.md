...
- Выборка: 20 объектов, собаки одной породы
    - Класс 0 (male dogs): вес < 4 кг
    - Класс 1 (female dogs): вес > 4 кг
- Признак: **вес** (x)
...
# Диагностика классификации: тест инвертирования классов
...
## Проблема: как обнаружить "ленивую" модель?
